...
console.log(
  ...
  MONGO_URI ? "MongoDB Atlas (Nube)" : "❌ MONGO_URI no encontrada"
);
...
async function runSeed() {
  try {
    ...
    await User.collection
      .drop()
      .catch((e) => console.log("Colección users ya limpia o inexistente"));
    await Company.collection
      .drop()
      .catch((e) => console.log("Colección companies ya limpia o inexistente"));
    await ProductiveStage.collection
      .drop()
      .catch((e) =>
        console.log("Colección productivestages ya limpia o inexistente")
      );
    await Batch.collection
      .drop()
      .catch((e) => console.log("Colección batches ya limpia o inexistente"));
    await SystemConfig.collection
      .drop()
      .catch((e) =>
        console.log("Colección systemconfigs ya limpia o inexistente")
      );
    ...
    const companiesData = [
      {
        ...
        jefe_inmediato: {
          ...
          telefono: "3154445566",
          correo: "jperez@techsolutions.com",
        },
      },
      {
    ...
    await SystemConfig.create([
      ...
      },
      {
        ...
        valor: 2,
        descripcion:
          "Horas asignadas por visita/seguimiento programado (defecto 2h).",
      },
      {
        clave: "HORAS_EXTRAORDINARIOS",
        valor: 2,
        descripcion:
          "Horas asignadas por seguimientos extraordinarios o comités.",
      },
      {
      ...
      },
      {
        ...
        descripcion:
          "Horas de etapa productiva requeridas por modalidad de actividad.",
      },
      {
        clave: "CLOUD_STORAGE_PROVIDER",
        valor: "GOOGLE_DRIVE",
        descripcion:
          "Proveedor de almacenamiento en la nube activo (GOOGLE_DRIVE o ONEDRIVE).",
      },
      {
        clave: "MAX_BITACORAS",
        valor: 13,
        descripcion:
          "Número máximo de bitácoras semanales permitidas por Etapa Productiva.",
      },
      {
        clave: "SEGUIMIENTOS_OBLIGATORIOS",
        valor: 3,
        descripcion:
          "Cantidad mínima de visitas de seguimiento realizadas obligatorias para finalizar.",
      },
      {
        clave: "DIAS_ANTICIPACION_ALERTA_SEGUIMIENTO",
        valor: 5,
        descripcion:
          "Días de anticipación para notificar al instructor sobre seguimientos programados.",
      },
    ]);
