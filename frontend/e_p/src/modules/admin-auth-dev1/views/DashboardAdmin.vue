...
.role-card input { display: none; }
.role-card.active { border-color: #1b5e20; background: #f0fdf4; }
.role-card .role-icon { font-size: 1.5rem; }
.role-card .role-info strong { display: block; font-size: 0.9rem; color: #1e293b; }
.role-card .role-info p { font-size: 0.7rem; color: #64748b; margin: 2px 0 0; }
